...
import motion_tracking.positional_tracking.zed_model as zm
...
class PyTrackingViewer:
    ...
    def init(self):
        ...
        glutCreateWindow(b"Tracking Viewer")
    ...
    def update_football_traking(self, xs, ys, zs):
        self.zed3d.set_football(xs, ys, zs)

    def update_true_football_traking(self, xs, ys, zs):
        self.zed3d.set_true_football(xs, ys, zs)
    ...
    def redraw(self):
        ...
        # self.draw_repere()
        # self.draww()
        self.zed3d.traking_draw()
        self.zed3d.true_traking_draw()
        self.zed3d.draw()
        self.print_text()
        self.path_locker.release()
        glutSwapBuffers()
    ...
    def print_text(self):
        ...
        safe_glut_bitmap_string("practiced:")

        glColor3f(0.4980, 0.5490, 0.5529)
        glRasterPos2i(155, start_h - 75)
        safe_glut_bitmap_string(self.txt_pra)

        glColor3f(0.9255, 0.9412, 0.9451)
        glRasterPos2i(start_w, start_h - 100)
        safe_glut_bitmap_string("predicted:")

        glColor3f(0.4980, 0.5490, 0.5529)
        glRasterPos2i(155, start_h - 100)
        safe_glut_bitmap_string(self.txt_pre)
    ...
    def update_value(self, string_t, string_r):
        if not self.get_viewer_state():
            return

        self.txt_pra = string_t
        self.txt_pre = string_r
