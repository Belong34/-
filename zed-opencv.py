...
def main():
    ...
    init.svo_input_filename = "C:\\Users\\Administrator\\Documents\\ZED\\HD1080_SN24807_14-07-15.svo"
    key = 0
    # Open the camera
    err = zed.open(init)
    ...
    while True:
        ...
        if err == sl.ERROR_CODE.SUCCESS:
            ...
            binary_output = cv2.inRange(hsv_image, (70, 131, 17), (130, 204, 109))
            ...
            print(ball)
            cv2.circle(image_ocv, (ball_list[0], ball_list[1]), 10, (255, 0, 0), -1)
